...
<head>
  ...
  <title>Character by Character Viewer</title>
  <style>
    body {
...
<body>
  ...
  <script>
    ...
    const sentences = [
      ...
      "An IT student at SVU 3rd year",
      "I'am a problem solver",
      "Now, I'm interested in CTF"
    ...
    function displaySentence(index, charIndex) {
      ...
      if (charIndex <= currentSentence.length) {
        sentenceElement.textContent = currentSentence.slice(0, charIndex);
