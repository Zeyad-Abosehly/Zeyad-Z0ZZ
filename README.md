<div>
  ...
  <script>
    const sentences = [
      { text: "Hi 👋, I'm Zeyad Abosehly", style: "font-weight: bold;color: #007BFF;" },
      { text: "An IT student at SVU 3rd year", style: "font-weight: bold;color: #007BFF;" },
      { text: "I'am a problem solver", style: "font-weight: bold;color: #007BFF;" },
      { text: "Now, I'm interested in CTF", style: "font-weight: bold;color: #007BFF;" }
    ];
